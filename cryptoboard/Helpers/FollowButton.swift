...
class FollowButton: UIButton {
    ...
    open var imageColorOn: UIColor! = UIColor(red: 255/255, green: 172/255, blue: 51/255, alpha: 1.0) {
        didSet {
            if (isSelected) {
    ...
    open var imageColorOff: UIColor! = UIColor(red: 136/255, green: 153/255, blue: 166/255, alpha: 1.0) {
        didSet {
            if (!isSelected) {
    ...
    open var circleColor: UIColor! = UIColor(red: 255/255, green: 172/255, blue: 51/255, alpha: 1.0) {
        didSet {
    ...
    open var lineColor: UIColor! = UIColor(red: 250/255, green: 120/255, blue: 68/255, alpha: 1.0) {
        didSet {
            for line in lines {
    ...
    @objc func touchDown(_ sender: FollowButton) {
        self.layer.opacity = 0.4
    }
    @objc func touchUpInside(_ sender: FollowButton) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragExit(_ sender: FollowButton) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragEnter(_ sender: FollowButton) {
        self.layer.opacity = 0.4
    }
    @objc func touchCancel(_ sender: FollowButton) {
        self.layer.opacity = 1.0
    }
